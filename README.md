...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/crc64iso-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13213&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crc64iso-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `crc64iso` can be installed with:

```
conda install crc64iso
```

It is possible to list all of the versions of `crc64iso` available on your platform with:
